...
<html lang="es">
    ...
    <body>
        ...
        <div id="payment-modal" class="payment-modal">
            <div class="payment-content">
                ...
                <div class="payment-options">
                    ...
                    <div id="wallet_container" style="margin-top: 10px; width: 100%;"></div>
                    ...
                    document.querySelector(".paypal-btn")?.addEventListener("click", function () {
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: async function (data, actions) {
                                console.log("Pedido aprobado por PayPal");
                                const details = await actions.order.capture();
                                console.log("Detalles del pago: " + JSON.stringify(details));
                            ...
                            onError: function (err) {
                                ...
                                alert("Ocurrio un error en PayPal. Por favor intenta de nuevo.");
                            },
                ...
                try {
                    ...
                    mp.checkout({
                        ...
                        onSuccess: async function (payment) {
                            console.log("Pago completado por Mercado Pago");
                        ...
                        onPending: function (payment) {
                            console.warn("Pago pendiente: " + payment);
                            alert("Tu pago esta pendiente de confirmacion");
                        }
                    });
        ...
        <script>
        // ===============================
        // BOTON CHECKOUT - ABRE MODAL DE UBICACION
        // ===============================
            document.querySelector(".checkout")?.addEventListener("click", function () {
                console.log("Click en checkout");

                const validacion = verificarSesionYUbicacion();
                if (!validacion.valido) {
                    console.log("Validacion fallida: " + validacion.mensaje);
            ...
            // ===============================
            // EVENTO: CUANDO SE CONFIRMA UBICACION
            // ===============================
            function confirmarpedidoConUbicacion() {
                console.log("Usuario confirmo ubicacion");
