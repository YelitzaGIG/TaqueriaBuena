...
<body>
  ...
  <section class="menu-section">
    <div class="menu-header">
      ...
      <h2 class="menu-title">MENÚ TACOS</h2>
      <div class="menu-deco"></div>
    </div>
    <div class="carousel">
      <div class="carousel-track">
        <div class="carousel-item">
          <img src="../images/tacoscachete.png" alt="Cachete">
          <p>Tacos de cachete</p>
        </div>
        <div class="carousel-item">
          <img src="../images/tacoslengua.png" alt="Lengua">
          <p>Tacos de lengua</p>
        ...
        <div class="carousel-item">
          <img src="../images/tacolabio.png" alt="Labio">
          <p>Tacos de labio</p>
        </div>
        <div class="carousel-item">
          <img src="../images/tacosojo.png" alt="Ojo">
          <p>Tacos de ojo</p>
        </div>
        <div class="carousel-item">
          <img src="../images/tacossesos.png" alt="Sesos">
        ...
        <div class="carousel-item">
          <img src="../images/tacostripa.png" alt="Tripa">
          <p>Tacos de tripa</p>
        </div>
        <div class="carousel-item">
          <img src="../images/tacoscabeza.png" alt="Mixto">
          <p>Tacos mixtos</p>
        </div>
