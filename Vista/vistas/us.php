...
<section class="sustentable section" id="sustentabilidad">
    ...
    <div class="sustentable-grid">
        ...
        <div class="s-card sabor-card glass">
            ...
            <!-- SALSAS -->
            <section class="salsas section" aria-label="Selector de salsas">
                <h3 class="titulo-seccion">Selecciona tu salsa</h3>

                <div class="salsa-row">
                    <button class="salsa-btn" data-salsa="verde">
                        <img src="../images/salsa_verde.svg"><span>Verde</span>
                    </button>

                    <button class="salsa-btn" data-salsa="roja">
                        <img src="../images/salsa_roja.svg"><span>Roja</span>
                    </button>

                    <button class="salsa-btn" data-salsa="chipotle">
                        <img src="../images/salsa_chipotle.svg"><span>Chipotle</span>
                    </button>
                </div>

                <p class="nota-salsa">Haz clic para marcar tu favorita (decorativo).</p>
            </section>
