...
// ===============================
// ESTADO INICIAL DEL MENU - VERSIÓN MEJORADA
// ===============================
...
// ===============================
// HABILITAR BOTONES - VERSIÓN MEJORADA
// ===============================
function habilitarBotonesMenu() {
    ...
    if (botones.length === 0) {
        ...
        setTimeout(() => {
            console.log("  🔄 Reintentando habilitar botones...");
            const botonesRetry = document.querySelectorAll(".plus-btn");
    ...
    botones.forEach(function(btn) {
        ...
        // Aplicar estilos de habilitación
        btn.style.opacity = "1";
...
// ===============================
// DESHABILITAR BOTONES - VERSIÓN MEJORADA
// ===============================
...
// ===============================
// EJECUCION INICIAL - VERSIÓN MEJORADA
// ===============================
