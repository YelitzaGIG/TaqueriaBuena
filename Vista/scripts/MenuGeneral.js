// Vista/scripts/MenuGeneral.js - COMPLETO
...
function estadoInicialDelMenu() {
    ...
    console.log("Estado inicial del menu");
    console.log("Usuario: " + (usuario ? usuario.nombre : "ninguno"));

    if (!usuario || !usuario.id) {
        console.log("Sin usuario - Menu visible, pedidos deshabilitados");
    ...
    console.log("Ubicacion valida: " + ubicacion.direccion);
