...
function actualizarUbicacion(lat, lng, direccion) {
    ...
    if (dentroRango) {
        ...
        mensajeEl.innerHTML = `Estas a ${km} km de la taqueria.<br>Fuera del area de entrega.`;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (btnValidarUbicacion) {
        btnValidarUbicacion.addEventListener("click", async function() {
            ...
            if (!dentro_rango) {
                alert("Tu ubicacion esta fuera de nuestro rango de entrega (3 km)");
                return;
            }
            ...
            try {
                ...
                if (data.status === "success") {
                    ...
                    if (guardado) {
                        ...
                        console.log("Menu habilitado correctamente");
                    } else {
                        alert("Error: Debes iniciar sesion primero");
                    }
                    
                } else {
                    console.log("Error en validacion del servidor");
